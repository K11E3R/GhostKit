...
@pytest.mark.skipif(not os.environ.get("RUN_FUNCTIONAL_TESTS"), 
...
class TestDVWA:
    ...
    def test_xss_scanner(self, dvwa_session):
        ...
        assert "XSS" in result.stdout and "vulnerability" in result.stdout.lower(), \
    ...
    def test_sqli_scanner(self, dvwa_session):
        ...
        assert "SQL" in result.stdout and "injection" in result.stdout.lower(), \
...
if __name__ == "__main__":
    ...
    try:
        ...
        if r.status_code == 200:
            ...
            print("You can start DVWA with Docker: docker run --rm -it -p 8080:80 vulnerables/web-dvwa")
