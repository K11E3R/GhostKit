...
class GhostKit:
                ...
                try:
                    ...
                    if hasattr(module, "Module"):
                        ...
                        if module_name == "web_xss_scanner":
                            ...
                            logger.info(f"Registered module alias: xss_scanner -> web_xss_scanner")
                except Exception as e:
    ...
    def run(self, args=None):
        ...
        parser.add_argument("-m", "--module", action="append", help="Specify module to run")
        parser.add_argument("-v", "--verbose", action="store_true", help="Enable verbose output")
        parser.add_argument("-u", "--url", help="URL to scan")  # Added for test compatibility 
        parser.add_argument("-t", "--target", help="Target to scan")  # Added for test compatibility
        ...
        try:
            ...
            error_message = str(e) if hasattr(e, "__str__") else "Missing required arguments"
